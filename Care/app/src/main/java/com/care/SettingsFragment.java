...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragView.findViewById(R.id.buttonCancel).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        fragView.findViewById(R.id.buttonAccept).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Bundle bundle = new Bundle();

                EditText fieldState = fragView.findViewById(R.id.editTextState);
                String state = fieldState.getText().toString();
                bundle.putString("state", state);

                EditText fieldType = fragView.findViewById(R.id.editTextType);
